          ...
          <div className="max-w-3xl mx-auto">
            <div className="relative pl-8 sm:pl-32 py-6 group">
              ...
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-4 after:h-4 after:bg-portfolio-primary after:border-2 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                <time className="sm:absolute sm:left-0 sm:ml-2 sm:text-right sm:min-w-[5.5rem] flex items-center justify-center text-xs font-semibold uppercase text-white bg-slate-700 h-6 mb-3 sm:mb-0 px-3 rounded-full">
                  Aug 2024
                </time>
              ...
              <ul className="space-y-3">
                ...
                >
                  ...
                  <span>
                    Developing responsive web interfaces using HTML, CSS,
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Working with backend Django REST APIs for full-stack feature
                    implementation
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Implementing booking system UI flows and community features
                    for sports platform
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Building and optimizing UI components for improved user
                    experience
                  </span>
                </motion.li>
              </ul>
            ...
            <div className="relative pl-8 sm:pl-32 py-6 group">
              ...
              <ul className="space-y-3">
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Developed automated Python scripts for LibreNMS, increasing
                    network monitoring efficiency by 45% and reducing manual
                    configuration time
                  </span>
                </motion.li>
                <motion.li
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Implemented Linux system administration best practices,
                    optimizing server performance and security protocols
                  </span>
                </motion.li>
                <motion.li
                  className="flex items-start"
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Conducted in-depth analysis of SNMP logs, identifying and
                    resolving critical network bottlenecks
                  </span>
                </motion.li>
                <motion.li
                  className="flex items-start"
                ...
                >
                  <span className="text-portfolio-primary mr-2">•</span>
                  <span>
                    Successfully resolved Python version conflicts in production
                    environments, ensuring seamless integration of monitoring
                    tools
                  </span>
                </motion.li>
              </ul>
            ...
            <div className="relative pl-8 sm:pl-32 py-6 opacity-50 group">
              <div className="flex flex-col sm:flex-row items-start mb-1 group-last:before:hidden before:absolute before:left-2 sm:before:left-0 before:h-full before:px-px before:bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:absolute after:left-2 sm:after:left-0 after:w-4 after:h-4 after:bg-gray-400 after:border-2 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5">
                <time className="sm:absolute sm:left-0 sm:ml-2 sm:text-right sm:min-w-[5.5rem] flex items-center justify-center text-xs font-semibold uppercase text-white bg-slate-400 h-6 mb-3 sm:mb-0 px-3 rounded-full">
                  Future
                </time>
              ...
              <div className="text-slate-400">
                Open to new opportunities in software development, AI/ML, and
                computer vision.
              </div>
            </div>
          </div>
