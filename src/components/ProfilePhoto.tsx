...
const images = [
  ...
  `${basePath}/imgs/666407de-5157-471c-8edb-f7f228b05a17.png`,
  `${basePath}/imgs/031321d2-a4dd-49ff-8bf8-eeaa440ab788.png`,
  `${basePath}/imgs/113b4417-c595-4401-852b-3a523573701e.png`,
];
      ...
      {images.map((image, index) => (
        <motion.div
          ...
          style={{
            left: `${index * 25}%`,
            zIndex:
              hoveredIndex === index ? 10 : images.length - Math.abs(index),
          }}
          initial={{
            rotate: (index - 2) * 5,
          }}
          animate={{
            ...
            filter:
              hoveredIndex === index ? "brightness(1.1)" : "brightness(1)",
            rotate:
              hoveredIndex === null
                ? (index - 2) * 5
                : hoveredIndex === index
